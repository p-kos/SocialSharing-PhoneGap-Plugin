...
public class SocialSharing extends CordovaPlugin {
  ...
  private static final String ACTION_SHARE_EVENT_IMAGES = "shareImages";
  ...
  public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
    ...
    } else if (ACTION_SHARE_EVENT_IMAGES.equals(action)) {
      return doSendIntent(callbackContext, args.getString(0), null, args.getString(1), args.getJSONArray(2), null, null, false, true);
